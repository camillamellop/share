...
```bash
git remote add encore encore://leap-app-i4qi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/leap-app-i4qi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/leap-app-i4qi/settings/integrations/github)
